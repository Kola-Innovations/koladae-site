...
export default function HeroSection({
  ...
  return (
    <div className="relative h-screen w-full overflow-hidden bg-black">
      ...
      {/* Side Blocks - COMING / SOON or OUT / NOW */}
      <div
        className="side-block side-block-left"
        style={{
          animation: loaded ? "slideInLeft 0.8s ease forwards" : "none",
          animationDelay: "0.6s",
          opacity: 0,
      ...
      <div
        className="side-block side-block-right"
        style={{
          animation: loaded ? "slideInRight 0.8s ease forwards" : "none",
          animationDelay: "0.6s",
          opacity: 0,
          animationFillMode: "forwards",
        }}
      ...
      >
        ...
        >
          ...
          >
            <span
              className={`rotating-word ${isAnimating ? "animating" : ""}`}
              style={{
